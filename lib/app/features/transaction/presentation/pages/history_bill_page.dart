...
class _HistoryBillPageState extends State<HistoryBillPage> {
  late final HistoryBillCubit _historyBillCubit;
  @override
  void initState() {
    _historyBillCubit = di.get<HistoryBillCubit>();
    _historyBillCubit.onInit();
    super.initState();
  }
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) => Padding(
                              padding: EdgeInsets.only(
                                left: (index == 0) ? 16.w : 0,
                                right: (index == tabTransaksi.length - 1)
                                    ? 16.w
                                    : 0,
                              ),
                              child: ButtonFilter(
                  ...
                  child: ConditionalSwitch.single(
                    ...
                    caseBuilders: {
                      ...
                      ViewState.empty: (context) => GeneralEmptyErrorWidget(
                            onRefresh: _historyBillCubit.onGetDatas,
                          ),
